...
int main(int argc, char** argv)
{
    ...
    // Load the DLL hashes generated by CMake and exposed as a macro, turning them from hex strings into their binary form.
    static uint64_t sha512_hash[8] = {0};
    static uint64_t md5_hash[2] = {0};
    hash_string_to_hash((uint8_t*) PDPM_SHA512, (uint8_t*) &sha512_hash);
    hash_string_to_hash((uint8_t*) PDPM_MD5, (uint8_t*) &md5_hash);
